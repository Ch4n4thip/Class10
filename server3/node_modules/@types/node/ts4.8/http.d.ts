...
declare module 'http' {
     ...
     * * `'socket'`
     * * (`req.destroy()` called here)
     * * `'error'` with an error with message `'Error: soc
...
function reportConnectionEvent(e) {
    ...
    if ('online' == e.type) {
        // Using a setTimeout to account for any lag between us getting the connected event and the machine obtaining an IP.
